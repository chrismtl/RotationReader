...
i_up:	
	...
	rjmp	a_rise
a_fall:
	rcall rotation_right					; if B=1 then increment
	sbrs	_w,ENCOD_B
	rcall rotation_left		; if B=0 then decrement
	rjmp	i_up_done
a_rise:
	rcall rotation_right					; if B=0 then increment
	sbrc	_w,ENCOD_B
	rcall rotation_left			; if B=1 then decrement
i_up_done:
	clz						; clear Z
	ret
